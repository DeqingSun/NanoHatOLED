...
process = subprocess.Popen(scriptFolder+'/toolAndBin/vnproch55x '+scriptFolder+'/toolAndBin/speedDemon20201116.bin', shell=True, stdout=subprocess.PIPE)
outputBuffer = ''
